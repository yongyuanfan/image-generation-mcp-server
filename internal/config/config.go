...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		ARKTextModel:         envOrDefault("ARK_MODEL_TEXT2IMAGE", "doubao-seedream-3-0-t2i-250415"),
		ARKImageModel:        envOrDefault("ARK_MODEL_IMAGE2IMAGE", "doubao-seededit-3-0-i2i-250628"),
